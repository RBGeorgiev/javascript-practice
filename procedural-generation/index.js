...
function updateHtmlDisplayedValues() {
    ...
    for (let b in mapGen.biomeCount) biomeCountDiv.innerText += `<span class="biomeCountBiome">${b}</span> <span class="biomeCountValue">${mapGen.biomeCount[b]}</span>`; // display biome count in
}
